...
env = gym.make('carla_rl-gym-v0', time_limit=30, verbose=False, initialize_server=True, random_weather=True, synchronous_mode=True, continuous=True, show_sensor_data=False, has_traffic=False)
...
for i in range(10):
    ...
    while not terminated and not truncated:
        a = [0.0, 0.0]
        action = env.act_space.sample()  # Replace with your desired action selection logic
