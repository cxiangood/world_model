...
def make_env():
    env = gym.make('carla_rl-gym-v0', time_limit=30, initialize_server=True, random_weather=False, synchronous_mode=True, continuous=False, show_sensor_data=True, has_traffic=True, verbose=False)
